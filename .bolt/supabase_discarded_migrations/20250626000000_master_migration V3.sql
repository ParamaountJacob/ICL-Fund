--
-- MASTER MIGRATION FILE (v5 - Final, Complete Version)
--
...
-- existing one.
--
-- v5 Correction: Added `docusign_envelope_id` to the 'documents' table.
-- This script is now complete and corrects all previous column errors.
--
...
ALTER TABLE public.documents
    ...
    -- THIS IS THE FINAL FIX: Ensure docusign_envelope_id column exists
...
BEGIN
    ...
    -- This INSERT will now succeed with all columns present
    INSERT INTO public.documents (application_id, user_id, type, signature_status, docusign_envelope_id)
    VALUES (p_application_id, v_user_id, p_document_type, v_signature_status, p_docusign_envelope_id)
...
-- ... (The rest of the essential functions: admin_sign_subscription_agreement, user_sign_promissory_note, etc., should be included here from the previous correct scripts) ...
