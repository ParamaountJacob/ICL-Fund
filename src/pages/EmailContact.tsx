    ...
    return (
        <div className="min-h-screen bg-background pt-20">
                ...
                <div className="container mx-auto px-4 sm:px-6 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 md:gap-3">
                            ...
                            <h1 className="text-lg md:text-xl font-semibold text-text-primary">Email</h1>
                        </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 pt-16 pb-6 md:pt-20 md:pb-8 max-w-4xl">
                ...
                {/* Mobile Footer Info */}
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.4 }} className="mt-6 md:mt-8 text-center">
                    <p className="text-sm text-text-secondary">
                        Need immediate assistance? Try our{' '}
                        <button onClick={() => navigate('/video-call-booking')} className="text-gold hover:text-gold/80 underline transition-colors">
                            video call booking
                        </button>{' '}
