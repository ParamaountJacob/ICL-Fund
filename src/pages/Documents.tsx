                            ...
                            {view === 'deck' ? (
                                ...
                                <div className="max-w-5xl mx-auto">
                                    <div className="max-w-3xl mx-auto mb-6 text-center">
                                        ...
                                        <p className="text-text-secondary">Inline preview below. Click to open full size or download.</p>
                                    </div>
                                    <div className="bg-accent border border-graphite rounded-xl overflow-hidden p-2 sm:p-3">
                                        <img
                                            src={onePagerUrl}
                                            alt="Inner Circle Lending One-Pager"
                                            className="w-full h-auto rounded-lg shadow-xl cursor-zoom-in"
                                            onClick={() => window.open(onePagerUrl, '_blank', 'noopener,noreferrer')}
                                        />
                                    </div>
                                    <div className="flex items-center justify-center gap-3 mt-6">
                                        <a href={onePagerUrl} target="_blank" rel="noreferrer" className="button">Open Full Size</a>
                                        <a href={onePagerUrl} download className="button bg-transparent border border-graphite hover:border-gold/50">Download Image</a>
                                    </div>
                                </div>
                            )}
                        </div>
